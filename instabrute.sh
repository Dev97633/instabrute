...
printf "\e[1;92m _____            _         _____            _\e[0m\n"
printf "\e[1;92m|     | ___  ___ | |_  ___ | __  | ___  _ _ | |_  ___\e[0m\n"
printf "\e[1;92m|-   -||   ||_ -||  _|| .'|| __ -||  _|| | ||  _|| -_|\e[0m\n"
printf "\e[1;92m|_____||_|_||___||_|  |__,||_____||_|  |___||_|  |___|\e[0m\n"
printf "\e[1;92m  By 4lxprime \e[0m\n"
printf "\n"
}
...
printf "\e[1;91mBad Username! Try again\e[0m\n"
sleep 1
start
else
...
default_threads="15"
read -p $'\e[1;92mThreads (Use < 25, Default 15): \e[0m' threads
